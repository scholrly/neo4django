...
``neo4django.testcases.NodeModelTestCase`` and run them as you normally would
...
A django-debug-toolbar_ panel_ has been written to make debugging Neo4j REST calls easier. It should also help debugging and optimizing neo4django.


``NodeModelTestCase.assertNumRequests`` can also help by ensuring round trips in a piece of test code don't grow unexpectedly.
